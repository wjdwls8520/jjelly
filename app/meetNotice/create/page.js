            ...
            <section className="section pt60 commonBoardSection meetSec">
                ...
                <div className="detailDataForm">
                    <div className="titleSpace spaceWrap">
                        <label className="tit">{title} 제목</label>
                        <h3 className="title">
                            <input type="text" id="inpGroupName" className="myInput bdCustom" autoComplete="off" placeholder={title + '제목'} />
                        </h3>
                    </div>
                    <div className="titleSpace spaceWrap">
                        <label className="tit">컨셉 분류</label>
                        <h3 className="title divition customSellectBox disabled">
                    ...
                    <div className="titleSpace spaceWrap">
                        ...
                        <h3 className="title region customSellectBox disabled">
                    ...
                    <div className="titleSpace spaceWrap">
                        <label className="tit">포스터 이미지</label>
